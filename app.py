...
# Enable CORS for all domains (update allowed_origins for production)
app.add_middleware(
    CORSMiddleware,
...
class ForecastRequest(BaseModel):
    ...
    horizon: int
    scenario: float = 0.0
    model_type: Optional[str] = "prophet"  # Options: "prophet", "neuralprophet", "auto"
